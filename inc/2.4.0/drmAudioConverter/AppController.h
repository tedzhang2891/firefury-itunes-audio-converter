...
@class BadgeNumberButton, HistoryWindowController, MTableView, NSButton, NSMenu, NSMutableArray, NSString, NSTextField, NSView, ProductController, ProgressWindowController;
...
- (void)removeRecordingDriver:(id)arg1;
